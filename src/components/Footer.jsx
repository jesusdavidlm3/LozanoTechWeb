  ...
  return (
    <div className='Footer'>
      <div className='contact'>
        <h1>Contactanos</h1>
        <h3><a target="_blank" href='https://wa.me/qr/X3Z6NWXVII44D1'>Whatsapp</a></h3>
        <h3><a target="_blank" href='https://www.instagram.com/lozanotech/'>Instagram</a></h3>
        <h3>Telefono: +58 412-7859759</h3>
        <h3>Email: lozanotech2020@gmail.com</h3>
      </div>
